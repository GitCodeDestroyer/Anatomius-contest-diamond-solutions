 ...
 *   https://datatables.net/download/#dt/jq-3.3.1/dt-1.10.20/af-2.3.4/cr-1.5.2/r-2.2.3/rg-1.1.1/rr-1.2.6/sp-1.0.1/sl-1.3.1
 *
 * Included libraries:
 *   jQuery 3 3.3.1, DataTables 1.10.20, AutoFill 2.3.4, ColReorder 1.5.2, Responsive 2.2.3, RowGroup 1.1.1, RowReorder 1.2.6, SearchPanes 1.0.1, Select 1.3.1
 */
...
d[c]=e,"o"===b[1]&&H(a[e]))});a._hungarianMap=d}function L(a,b,c){a._hungarianMap||H(a);var d;f.each(b,function(e,h){d=a._hungarianMap[e];d===p||!c&&b[d]!==p||("o"===d.charAt(0)?(b[d]||(b[d]={}),f.extend(!0,b[d],b[e]),L(a[d],b[d],c)):b[d]=b[e])})}function Ga(a){var b=q.defaults.oLanguage,c=b.sDecimal;c&&Ha(c);if(a){var d=a.sZeroRecords;!a.sEmptyTable&&d&&"Нет данных в таблице"===b.sEmptyTable&&M(a,a,"sZeroRecords","sEmptyTable");!a.sLoadingRecords&&d&&"Loading..."===b.sLoadingRecords&&M(a,a,
...
null===w.nTr&&La(a,m);var u=w.nTr;if(0!==e){var q=d[c%e];w._sRowStripe!=q&&(f(u).removeClass(w._sRowStripe).addClass(q),w._sRowStripe=q)}A(a,"aoRowCallback",null,[u,w._aData,c,k,m]);b.push(u);c++}else c=h.sZeroRecords,1==a.iDraw&&"ajax"==D(a)?c=h.sLoadingRecords:h.sEmptyTable&&0===a.fnRecordsTotal()&&(c=h.sEmptyTable),b[0]=f("<tr/>",{"class":e?d[0]:""}).append(f("<td />",{colSpan:W(a),"class":a.oClasses.sRowEmpty}).html(c))[0];A(a,"aoHeaderCallback","header",[f(a.nTHead).children("tr")[0],
...
sNext:"Next",sPrevious:"Previous"},sEmptyTable:"Вы ничего не добавляли",sInfo:"Showing _START_ to _END_ of _TOTAL_ entries",sInfoEmpty:"Showing 0 to 0 of 0 entries",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Show _MENU_ entries",sLoadingRecords:"Загружается...",sProcessing:"Выполняется...",sSearch:"Поиск:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Не найдены результаты для поиска"},oSearch:f.extend({},q.models.oSearch),sAjaxDataProp:"data",
...
classes:{},build:"dt/jq-3.3.1/dt-1.10.20/af-2.3.4/cr-1.5.2/r-2.2.3/rg-1.1.1/rr-1.2.6/sp-1.0.1/sl-1.3.1",errMode:"alert",feature:[],search:[],selector:{cell:[],column:[],row:[]},internal:{},legacy:{ajax:null},pager:{},renderer:{pageButton:{},header:{}},order:{},type:{detect:[],search:{},order:{}},_unique:0,fnVersionCheck:q.fnVersionCheck,iApiIndex:0,oJUIClasses:{},sVersion:q.version};f.extend(C,{afnFiltering:C.search,aTypes:C.type.detect,ofnSearch:C.type.search,oSort:C.type.order,afnSortData:C.order,aoFeatures:C.feature,oApi:C.internal,oStdClasses:C.classes,oPagination:C.pager});
